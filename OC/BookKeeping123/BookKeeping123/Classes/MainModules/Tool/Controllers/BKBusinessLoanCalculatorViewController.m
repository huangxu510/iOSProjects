//
//  BKBusinessLoanCalculatorViewController.m
//  BookKeeping123
//
...
@interface BKBusinessLoanCalculatorViewController ()

@end

@implementation BKBusinessLoanCalculatorViewController
...
- (void)setupUI {
    ...
    BKWordArrowItem *item4 = [BKWordArrowItem itemWithTitle:@"银行利率（%）" subTitle:@""];
