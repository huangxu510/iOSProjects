//
//  JCHProductRecordListViewController.m
//  jinchuhuo
//
...
@interface JCHProductRecordListViewController () <JCHItemListFooterViewDelegate,
...
@implementation JCHProductRecordListViewController
...
- (void)createUI
{
    ...
    footerView.categoryName = @"商品";
    footerView.categoryUnit = @"件";
...
{
    JCHAddProductRecordViewController *addController = [[[JCHAddProductRecordViewController alloc] initWithProductRecord:nil] autorelease];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        JCHAddProductRecordViewController *modifyRecordVC = [[[JCHAddProductRecordViewController alloc] initWithProductRecord:productRecord] autorelease];
        
        modifyRecordVC.productType = kJCHProductTypeModifyProduct;
        appearFromPop = YES;
