...
@interface JCHKeyboardUtility : NSObject<KeyboardUtilProtocol>
...
typedef void (^printKeyboardInfoBlock)(JCHKeyboardUtility *keyboardUtil, KeyboardInfo *keyboardInfo);
typedef void (^animateWhenKeyboardAppearAutomaticAnimBlock)(JCHKeyboardUtility *keyboardUtil);
