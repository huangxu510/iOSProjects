...
/** 打印二维码指令类型 */
typedef NS_ENUM(NSInteger, HLQRCodeCommandType) {
    HLQRCodeCommandTypeOne,         // 适合佳博打印机
    HLQRCodeCommandTypeTwo,         // 适合SGT-B58V和迅雷打印机
};
...
/**
 *  添加二维码
 *  ✅推荐：这种方式使用的是打印机的指令生成二维码并打印机，所以比较推荐这种方式 (适合佳博打印机)
 *
 *  @param info      二维码中的信息
